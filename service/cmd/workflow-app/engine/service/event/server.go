...
func (r *Server) Serve() error {
	...
	r.Register(NewDriveEventProcessor(domainService, eventBusRepo))
	r.Register(NewTriggerEventProcessor(domainService, eventBusRepo))
	r.Register(NewCronEventProcessor(domainService, eventBusRepo))
	r.Register(NewExternalEventProcessor(domainService, eventBusRepo))
