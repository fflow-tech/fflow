...
import (
	"flag"
	"github.com/fflow-tech/fflow/service/cmd/foundation/auth/service/rpc"
	"os"
	"os/signal"
	"syscall"

	_ "github.com/fflow-tech/fflow/service/cmd/foundation/auth/docs"
	_ "github.com/fflow-tech/fflow/service/internal/foundation/auth/domain/dto"

	"github.com/fflow-tech/fflow/service/cmd/foundation/auth/factory"
	"github.com/fflow-tech/fflow/service/cmd/foundation/auth/service/web"
...
var (
	httpAddr         = flag.String("http.addr", ":50041", "The http server address")
	grpcAddr         = flag.String("grpc.addr", ":50042", "The grpc server address")
...
func main() {
	...
	utils.ShutdownGraceful(httpServer.Close)
}
